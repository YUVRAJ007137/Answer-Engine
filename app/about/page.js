...
const linkBase =
  "inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:opacity-90 active:scale-[0.98]";
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <header className="text-center space-y-2">
          ...
          <p className="text-sm" style={{ color: "var(--muted)" }}>
            This product is made by Tech Desk.
          </p>
        </header>
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                Answer Engine is made by Tech Desk. It is an AI-powered tool
                designed to help students generate well-structured,
                handwriting-ready answers for their assignments. Simply upload
                or paste your questions, and get detailed answers with proper
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`${linkBase} font-semibold shadow-sm`}
                  style={{
                    background: "#FFDD00",
                    color: "#000",
                  }}
